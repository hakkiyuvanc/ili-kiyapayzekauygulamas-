...
export function WeeklyScoreCard() {
    ...
    return (
        <div className="grid grid-cols-2 gap-4">
            {/* Weekly Score */}
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-100 dark:border-green-800 rounded-2xl p-4 flex flex-col items-center justify-center text-center">
            ...
            {/* Streak */}
            <div className="bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 border border-orange-100 dark:border-orange-800 rounded-2xl p-4 flex flex-col items-center justify-center text-center">
