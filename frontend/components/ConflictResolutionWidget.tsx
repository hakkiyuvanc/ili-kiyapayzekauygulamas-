...
export function ConflictResolutionWidget() {
  ...
  if (!isOpen) {
    return (
      <div className="bg-red-50 dark:bg-red-900/20 border border-red-100 dark:border-red-800 rounded-2xl p-4 flex items-center justify-between">
  ...
  return (
    <div className="bg-white dark:bg-slate-800 border-2 border-red-100 dark:border-red-900 shadow-xl overflow-hidden relative rounded-2xl p-6">
      <button
        onClick={reset}
