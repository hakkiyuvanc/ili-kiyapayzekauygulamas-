    ...
    const steps = [
        {
            ...
            content: "Önce biyolojini sakinleştir. 4 saniye nefes al, 4 saniye tut, 4 saniye ver.",
            icon: Wind,
            action: "Sakince Aldım"
        },
        {
            title: "Duygunu Tanımla",
            content: "Ona saldırmak yerine ne hissettiğine odaklan. Öfke mi? Hayal kırıklığı mı? Korku mu?",
            icon: ShieldAlert,
            action: "Tanımladım"
        },
        {
            title: "'Ben' Dili Kullan",
            content: "'Sen hep böylesin' yerine 'Ben şu an incinmiş hissediyorum çünkü...' diye başla.",
            icon: Check,
            ...
            <Card className="bg-red-50 dark:bg-red-900/20 border-red-100 dark:border-red-800">
                <CardContent className="p-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="font-bold text-red-800 dark:text-red-200 text-sm">Çatışma Çözücü</h3>
                            <p className="text-xs text-red-600 dark:text-red-300">Şu an gergin misiniz?</p>
                        </div>
                    </div>
                    <Button
                            ...
                            <>
                                <div className="w-16 h-16 bg-red-50 dark:bg-red-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
                                    {(() => {
                                        ...
                                        return <Icon className="w-8 h-8 text-red-500" />;
                                    })()}
                                </div>
                                ...
                                >
                                    {steps[step].action} <ChevronRight className="w-4 h-4 ml-2" />
                                </Button>
                            </>
                        ) : (
                            <div className="py-6">
                                <Check className="w-16 h-16 text-green-500 mx-auto mb-4" />
                                <h3 className="text-xl font-bold text-gray-900 dark:text-white">Hazırsın!</h3>
                                <p className="text-gray-600 dark:text-gray-300 mb-4">Şimdi o konuşmayı sakince yapabilirsin.</p>
