...
class RelationshipMetrics:
    ...
    def __init__(self):
        ...
        self.positive_words = {
            "sevgi", "aşk", "mutlu", "güzel", "harika", "mükemmel", "iyi", "süper",
            "seviyorum", "özledim", "teşekkür", "sağol", "canım", "tatlım", "aşkım",
            "bebeğim", "güzelim", "harikasın", "anlıyorum", "destekliyorum", "gururluyum",
            "başarılı", "zeki", "komik", "eğlenceli", "heyecanlı", "mutluyum", "sevinçli",
            "minnettar", "şanslı", "beraber", "birlikte", "yanımda", "seni", "bizi",
        }

        self.negative_words = {
            "kötü", "berbat", "iğrenç", "sinir", "öfke", "nefret", "yalan", "aldatma",
            "hep", "hiç", "asla", "her zaman", "bıktım", "yoruldum", "sıkıldım", "usandım",
            "aptal", "salak", "ahmak", "gerizekalı", "umurumda", "değil", "boşver",
            "yanlış", "hata", "suç", "kabahat", "sen", "senin", "senden", "sana",
            "ben", "benim", "bana", "üzgün", "mutsuz", "kızgın", "sinirli", "stresli",
        }

        # Empati göstergeleri
        self.empathy_indicators = {
            "anlıyorum", "anlayabiliyorum", "hissediyorum", "görüyorum", "biliyorum",
            "haklısın", "doğru", "katılıyorum", "seninle", "senin için", "üzülüyorum",
            "destekliyorum", "yanındayım", "yardımcı", "dinliyorum", "anlamak",
            "ne hissettiğini", "nasıl hissettiğini", "neler yaşadığını",
            "canım", "aşkım", "bebeğim", "tatlım", "güzelim", "hayatım",
            "sevgilim", "kalbim", "özledim", "seni düşünüyorum", "merak ediyorum",
            "nasılsın", "iyi misin", "yanındayım", "seninleyim", "sana güveniyorum",
        }
        ...
        self.conflict_indicators = {
            "ama", "fakat", "ancak", "lakin", "oysa", "halbuki", "ne var ki",
            "hep", "hiç", "asla", "her zaman", "hiçbir zaman", "sürekli", "daima",
            "yine", "gene", "tekrar", "yeter", "bıktım", "usandım", "yoruldum",
            "sen hep", "sen hiç", "sen her zaman", "sen asla", "neden hep",
        }

        # "Biz" dili göstergeleri
        self.we_language = {
            "biz", "bizim", "bize", "bizden", "birlikte", "beraber", "ikimiz",
            "bizimle", "beraberce", "ortak", "paylaş", "paylaşalım", "yapalım",
            "gidelim", "edelim", "olalım", "düşünelim", "konuşalım",
        }

        # "Ben/Sen" dili göstergeleri
        self.i_you_language = {
            "ben", "benim", "bana", "benden", "benimle", "sen", "senin",
            "sana", "senden", "seninle", "seni", "beni",
        }
    ...
    def calculate_conflict_score(self, text: str) -> Dict[str, float]:
        ...
        exclamation_bonus = max(0, (exclamation_ratio - 0.2)) * 100 if exclamation_ratio > 0.2 else 0
    ...
    def calculate_communication_balance(
                ...
                "distribution": {
                    p1: {
                        "message_percentage": round(
                            (message_counts[p1] / total_messages) * 100, 2
                        ),
                        "word_percentage": round((word_counts[p1] / total_words) * 100, 2),
                    },
                    p2: {
                        "message_percentage": round(
                            (message_counts[p2] / total_messages) * 100, 2
                        ),
        ...
        import statistics
        percentages = [
            (count / total_messages) * 100 for count in message_counts.values()
        ]
