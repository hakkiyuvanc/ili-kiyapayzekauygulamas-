...
def cached_turkish_words():
    ...
    positive_words = [
        'seviyorum', 'aşkım', 'canım', 'güzel', 'harika', 'mükemmel',
        'mutlu', 'şanslı', 'keyifli', 'hoş', 'tatlı', 'sevimli',
        'muhteşem', 'enfes', 'eğlenceli', 'heyecanlı', 'başarılı',
        'bebeğim', 'hayatım', 'özledim', 'gülüm', 'teşekkür'
    ]
    
    negative_words = [
        'kızgın', 'sinirli', 'üzgün', 'mutsuz', 'kötü', 'berbat',
        'yorgun', 'stresli', 'endişeli', 'kaygılı', 'gergin', 'sıkıcı',
        'can sıkıcı', 'yanlış', 'hata', 'sorun', 'problem', 'kavga',
        'tartışma', 'anlaşmazlık', 'bıktım', 'usandım'
    ]
