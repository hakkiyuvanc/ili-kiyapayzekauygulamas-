...
def test_db():
    ...
    # Use temp file instead of in-memory to completely avoid metadata cache issues
    import os
    import tempfile
    ...
    # CRITICAL: Clear metadata BEFORE importing models
    # This prevents index conflicts from previous test runs
    Base.metadata.clear()

    # Reload the models module to get fresh metadata
    import importlib
