...
class TestAnalysisRepository:
    ...
    def test_get_by_user(self, analysis_repo, test_user, test_db):
        ...
        for i in range(3):
            analysis_repo.create(Analysis(user_id=test_user.id, overall_score=70.0, text_length=100))
            analysis_repo.create(Analysis(user_id=other_user.id, overall_score=80.0, text_length=100))
