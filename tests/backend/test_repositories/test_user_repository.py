...
class TestUserRepository:
    ...
    def test_get_pro_users(self, user_repo):
        ...
        user_repo.create(
            User(email="free1@example.com", hashed_password="h", full_name="Free", is_pro=False)
        )
        user_repo.create(
            User(email="pro1@example.com", hashed_password="h", full_name="Pro 1", is_pro=True)
        )
        user_repo.create(
            User(email="pro2@example.com", hashed_password="h", full_name="Pro 2", is_pro=True)
        )
    ...
    def test_get_unverified_users(self, user_repo):
        ...
        # Arrange
        user_repo.create(
            User(email="verified@example.com", hashed_password="h", full_name="V", is_verified=True)
        )
        user_repo.create(
            User(
