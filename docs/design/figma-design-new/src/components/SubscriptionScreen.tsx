  ...
  return (
    <div className="bg-white rounded-3xl shadow-2xl p-6 max-h-[90vh] overflow-y-auto">
      ...
      <div className="space-y-2 text-center">
        ...
        <p className="text-xs text-gray-400">7 gün para iade garantisi</p>
      </div>
    </div>
  );
}
...
function PricingCard({
  ...
  return (
    <div
      className={`relative p-4 rounded-2xl border-2 transition-all cursor-pointer hover:scale-[1.02] ${
        popular
