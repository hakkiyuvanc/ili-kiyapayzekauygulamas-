          ...
          <div className="mb-4">
            ...
            <div className="space-y-2">
              ...
              {!isPro && insight.strengths.length > 2 && (
                <LockedContent
                  onUpgrade={onUpgrade}
                  count={insight.strengths.length - 2}
                />
              )}
            </div>
          </div>
            ...
            <div className="space-y-2">
              {insight.riskAreas
                ...
                .map((risk, index) => (
                  <div
                    key={index}
                    className="flex items-start gap-2 p-3 bg-orange-50 border border-orange-200 rounded-xl"
                  >
              ...
              {!isPro && insight.riskAreas.length > 2 && (
                <LockedContent
                  onUpgrade={onUpgrade}
                  count={insight.riskAreas.length - 2}
                />
              )}
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="space-y-2">
              ...
              {!isPro && insight.findings.length > 3 && (
                <LockedContent
                  onUpgrade={onUpgrade}
                  count={insight.findings.length - 3}
                />
              )}
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="space-y-3">
              ...
              {!isPro && insight.recommendations.length > 2 && (
                <LockedContent
                  onUpgrade={onUpgrade}
                  count={insight.recommendations.length - 2}
                />
              )}
            </div>
          </div>
